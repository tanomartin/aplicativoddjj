...
<table width="700" height="128" border="1" align="center">
  <tr>
    <td width="683" height="27"><div align="center"><font size="2" face="Arial, Helvetica, sans-serif"><strong><em>Carga de Archivos de Alta de Titulares </em></strong></font></div></td>
  </tr>
  <tr>
    <td height="71"><form action="subidaArcEmp.php" method="post" enctype="multipart/form-data">
      <p align="center">
