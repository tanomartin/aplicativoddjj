...
<form method="post" action="../grabatotalesDdjj.php?filas=<?php echo $filas;?>&ctrlh=<?php echo $ctrlh;?>">
	...
	$nfilas = ($filas*4) + 3;
	print ("<font face=Verdana size=2><b>Período: ".$permes."/".$perano."</b></font>");
	print ("<br>");
	print ("<br>");
	print ("<br>");
	...
	print ("Recargos  :  ");
	print ("<input type=text name=T1 size=10 value=0.00><br><input type=text name=S1 size=15 value=Observaciones>");
	print ("<br>");
