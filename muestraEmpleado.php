...
?>
                ...
                <td width="298"><font face="Arial, Helvetica, sans-serif" size="2"><? echo $cuil01."-".$cuil02."-".$cuil03; ?></font></td>
              </tr>
              <tr> 
                <td width="217"><b><font face="Verdana" size="1">Nombre</font></b></td>
                <td width="298"><font face="Arial, Helvetica, sans-serif" size="2"><? echo $row['nombre']; ?></font></td>
              </tr>
              <tr> 
                <td width="217"><b><font face="Verdana" size="1">Apellido</font></b></td>
                <td width="298"><font face="Arial, Helvetica, sans-serif" size="2"><? echo $row['apelli']; ?></font></td>
              </tr>
              <tr> 
<?php
...
$fec03 = substr($row['fecing'],8,2);
  ?>
                ...
                <td width="298"><font face="Arial, Helvetica, sans-serif" size="2"><? echo $fec03."/".$fec02."/".$fec01;?></font></td>
              </tr>
              <tr> 
                <td width="217"><b><font face="Verdana" size="1">Tipo y Número 
                  de Documento</font></b></td>
                <td width="298"><font face="Arial, Helvetica, sans-serif" size="2"><? echo $row['tipdoc']." ".$row['nrodoc']; ?></font></td>
              </tr>
              <tr> 
                <td width="217"><b><font face="Verdana" size="1">Sexo</font></b></td>
                <td width="298"><font face="Arial, Helvetica, sans-serif" size="2"><? echo $row['ssexxo']; ?></font></td>
              </tr>
              <tr> 
<?php
...
?>
                ...
                <td width="298"><font face="Arial, Helvetica, sans-serif" size="2"><? echo $fecn03."/".$fecn02."/".$fecn01;?></font></td>
              </tr>
              <tr> 
                <td width="217"><b><font face="Verdana" size="1">Estado Civil</font></b></td>
                <td width="298"><font face="Arial, Helvetica, sans-serif" size="2"><? echo $row['estciv']; ?></font></td>
              </tr>
              <tr> 
                <td width="217"><b><font face="Verdana" size="1">Dirección</font></b></td>
                <td width="298"><font size="2" face="Arial, Helvetica, sans-serif"><? echo $row['direcc']; ?></font></td>
              </tr>
              <tr> 
                <td width="217"><b><font face="Verdana" size="1">Localidad</font></b></td>
                <td width="298"><font size="2" face="Arial, Helvetica, sans-serif"><? echo $row['locale']; ?></font></td>
              </tr>
              <tr> 
                <td width="217"><b><font face="Verdana" size="1">Código Postal</font></b></td>
                <td width="298"><font size="2" face="Arial, Helvetica, sans-serif"><? echo $row['copole']; ?></font></td>
              </tr>
              <tr> 
                <?php $pro = $row["provin"]; ?>
                <td width="217"><b><font face="Verdana" size="1">Provincia</font></b></td>
                <td width="298"><font size="2" face="Arial, Helvetica, sans-serif"><? echo $provincia [$pro] ?></font></td>
              </tr>
              <tr> 
                <td width="217"><b><font face="Verdana" size="1">Nacionalidad</font></b></td>
                <td width="298"><font face="Arial, Helvetica, sans-serif" size="2"><? echo $row['nacion']; ?></font></td>
              </tr>
              <tr> 
<?php
$cat = $row['catego'];
...
$pow=mysql_fetch_array($res);
	  ?>			  
                ...
                <td width="298"><font face="Arial, Helvetica, sans-serif" size="2"><? echo $pow['descri']; ?></font></td>
              </tr>
              <tr> 
                <td width="217"><b><font face="Verdana" size="1">Activo</font></b></td>
                <td width="298"><font face="Arial, Helvetica, sans-serif" size="2"><? echo $row['activo']; ?></font></td>
              </tr>
            </table>
            <p align="left"><font size="2" face="Arial, Helvetica, sans-serif"><strong><a href="modificacionEmpleado.php?nrcuil=<? echo $nrcuil ?>">Modificar</a> 
              - <a href="muestraeliminacionEmpleado.php?nrcuil=<? echo $nrcuil ?>"><font color="#660033">Eliminar Registro</font></a> 
              - <a href="listagrupoFamiliar.php?nrcuil=<? echo $nrcuil ?>">Grupo Familiar</a></strong></font></p>
            <p>&nbsp;</p></td>
          </tr>
          <tr>
